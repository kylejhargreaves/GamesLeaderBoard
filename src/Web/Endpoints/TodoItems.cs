using GamesLeaderboard.Application.Common.Models;
using GamesLeaderboard.Application.TodoItems.Commands.CreateTodoItem;
using GamesLeaderboard.Application.TodoItems.Commands.DeleteTodoItem;
using GamesLeaderboard.Application.TodoItems.Commands.UpdateTodoItem;
using GamesLeaderboard.Application.TodoItems.Commands.UpdateTodoItemDetail;
using GamesLeaderboard.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace GamesLeaderboard.Web.Endpoints;
